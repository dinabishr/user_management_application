...
import {
  ...
  Popper_default
} from "./chunk-2OTCLYGP.js";
import {
  ButtonBase_default,
  Typography_default
} from "./chunk-GG7LSAXX.js";
import "./chunk-XCH4OP2Z.js";
import {
  init_utils,
  useId_default
...
function PickersPopper(inProps) {
  ...
  const paperRef = React7.useRef(null);
  ...
  const PaperContent = (components == null ? void 0 : components.PaperContent) || React7.Fragment;
...
function DesktopWrapper(props) {
  ...
  const ownInputRef = React8.useRef(null);
      ...
      children: (0, import_jsx_runtime25.jsx)(PickersCalendarWeekContainer, {
        ...
        children: utils.getWeekArray(currentMonth).map((week) => (0, import_jsx_runtime25.jsx)(PickersCalendarWeek, {
          ...
          children: week.map((day) => {
            ...
            return renderDay ? renderDay(day, validSelectedDays, pickersDayProps) : (0, import_jsx_runtime25.jsx)(PickersDay2, _extends({}, pickersDayProps), pickersDayProps.key);
          })
        }, `week-${week[0]}`))
      })
    }))]
...
var useOpenState = ({
  ...
  const isControllingOpenProp = React35.useRef(typeof open === "boolean").current;
  const [openState, setIsOpenState] = React35.useState(false);
  React35.useEffect(() => {
  ...
  const setIsOpen = React35.useCallback((newIsOpen) => {
    if (!isControllingOpenProp) {
...
var usePickerState = (props, valueManager) => {
  ...
  const parsedDateValue = React36.useMemo(() => valueManager.parseInput(utils, value), [valueManager, utils, value]);
  const [lastValidDateValue, setLastValidDateValue] = React36.useState(parsedDateValue);
  const [dateState, setDateState] = React36.useState(() => ({
    committed: parsedDateValue,
    draft: parsedDateValue,
    resetFallback: parsedDateValue
  }));
  const setDate = React36.useCallback((params) => {
    setDateState((prev) => {
  ...
  const wrapperProps = React36.useMemo(() => ({
    open: isOpen,
    onClear: () => {
      setDate({
  ...
  const [isMobileKeyboardViewOpen, setMobileKeyboardViewOpen] = React36.useState(false);
  const pickerProps = React36.useMemo(() => ({
  ...
  const handleInputChange = React36.useCallback((newParsedValue, keyboardInputValue) => {
  ...
  const inputProps = React36.useMemo(() => ({
  ...
  React36.useDebugValue(pickerState, () => ({
    MuiPickerState: {
      dateState,
      other: pickerState
    }
